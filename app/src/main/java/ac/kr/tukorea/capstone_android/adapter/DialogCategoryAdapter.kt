...
class DialogCategoryAdapter(private var mList: ArrayList<String>, private val listener: OnItemClickListener)
    :RecyclerView.Adapter<DialogCategoryAdapter.ViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DialogCategoryAdapter.ViewHolder {
